...
function displayPhotographsInLightbox(lightBoxinfo) {
  if (lightBoxinfo.image) {
    console.log(lightBoxinfo.image);
    const lightBoxImageAsHtml = `<div class="previewBox">
  <div class="closing">
  ...
  <div class="photographBox">
    ...
    <img src="" class="lightBoxPhotograph")>
  </div>
  <span class="lightBoxPhotographTitle"></span>
</div>
<div class="shadow"></div>`;
    return lightBoxImageAsHtml;
  } else if (lightBoxinfo.video) {
    console.log(lightBoxinfo.video);
    const lightBoxVideoAsHtml = `<div class="previewBox">
    <div class="closing">
    <span class="lightboxClosingBtn"><i class="fas fa-times"></i></span>
    </div>
    <div class="photographBox">
...
theLightBoxSection.innerHTML = `${json["media"]

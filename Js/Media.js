...
// Arrays of every photographer stocked in a variable:
var mimiPics = media.filter(function(id){
    if (id.photographerId == "243"){
        return true
    }
});

console.log (mimiPics)

var ElliePics = media.filter(function(id){
    if (id.photographerId == "930"){
        return true    
    }
});

var TracyPics = media.filter(function(id){
    if (id.photographerId == "82"){
        return true
    }
});

var NabeelPics = media.filter(function(id){
    if (id.photographerId == "527"){
        return true
    }
});

var RhodePics = media.filter(function(id){
    if (id.photographerId == "925"){
        return true
    }
});

var MarcelPics = media.filter(function(id){
    if (id.photographerId == "195"){
        return true
    }
});

var everyPhotographerAlbum  = [ mimiPics,ElliePics,TracyPics,NabeelPics,RhodePics,MarcelPics]
console.log (everyPhotographerAlbum)



// on click filter tagss of photographss                             worksssss 
...
///// filter json section                                    needs workkkkk
